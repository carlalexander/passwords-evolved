<div class="wrap" id="passwords-evolved-admin">
    ...
    <?php if (!empty($_GET['updated'])) : ?>
        <div id="setting-error-settings_updated" class="updated settings-error notice is-dismissible">
            <p><strong><?php echo $this->translate('settings_saved'); ?></strong></p><button type="button" class="notice-dismiss"><span class="screen-reader-text"><?php $this->translate('dismiss_notice'); ?></span></button>
        </div>
    <?php endif; ?>
